...
from src.tools import normalize_category
...
class TestBlueprintAndAuditor(unittest.TestCase):
    ...
    def test_business_meal_categories_map_to_alimentacao(self):
        self.assertEqual(normalize_category("almoco de negocios"), "alimentacao")
        self.assertEqual(normalize_category("jantar de negocios"), "alimentacao")

    def test_viagem_maps_to_hospedagem(self):
        self.assertEqual(normalize_category("viagem"), "hospedagem")
